...
import com.eit.brnnda.databinding.FragmentPriveyPolecyBinding
...
class PriveyPolecyFragment :  Fragment() {
    private lateinit var binding: FragmentPriveyPolecyBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_privey_polecy, container, false
        )
