...
import com.eit.brnnda.databinding.FragmentCatWiseProductBinding
...
class CatWiseProductFragment : Fragment() {
    private lateinit var binding: FragmentCatWiseProductBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
                inflater,
                R.layout.fragment_cat_wise_product, container, false
        )
    ...
    private fun displayCategoryList(brandId: String) {
        vm.catWiseData(decodedStringKey, brandId).observe(viewLifecycleOwner, Observer {
    ...
    private fun productClick(selected: ProductDataItem) {
        ...
        findNavController().navigate(R.id.action_catWiseProductFragment_to_productFragment, bundle)
    }
