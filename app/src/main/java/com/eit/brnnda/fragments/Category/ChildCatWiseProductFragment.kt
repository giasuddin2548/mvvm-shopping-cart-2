...
import com.eit.brnnda.databinding.FragmentChildCatWiseProductBinding
...
class ChildCatWiseProductFragment : Fragment() {
    private lateinit var binding: FragmentChildCatWiseProductBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_child_cat_wise_product, container, false
        )
    ...
    private fun displayCategoryList(brandId: String) {
        vm.getChildCatWiseProduct(decodedStringKey, brandId).observe(viewLifecycleOwner, Observer {
    ...
    private fun productClick(selected: ProductDataItem) {
        ...
        findNavController().navigate(R.id.action_childCatWiseProductFragment_to_productFragment, bundle)
    }
