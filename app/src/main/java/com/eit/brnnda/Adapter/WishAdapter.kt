...
import com.eit.brnnda.databinding.SampleAllProductLayoutBinding
import com.eit.brnnda.dataclass.ProductDataItem
import java.util.*
import kotlin.collections.ArrayList

class WishAdapter(private val clickListener: (ProductDataItem) -> Unit ,private val clickListenerAddtoCart: (ProductDataItem) -> Unit) : RecyclerView.Adapter<WishViewHolder>(), Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WishViewHolder {
        ...
        val binding: SampleAllProductLayoutBinding = DataBindingUtil.inflate(view, R.layout.sample_all_product_layout, parent, false)
...
class WishViewHolder(private val binding: SampleAllProductLayoutBinding) :
    ...
    fun bind(data: ProductDataItem,
        ...
        binding.tvAdd.setImageResource(R.drawable.ic_baseline_delete_outline_black)
