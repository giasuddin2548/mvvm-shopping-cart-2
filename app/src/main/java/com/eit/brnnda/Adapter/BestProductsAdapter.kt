...
class BestProductsAdapter(private val clickListener: (ProductDataItem) -> Unit ,private val clickListenerAddtoCart: (ProductDataItem) -> Unit) : RecyclerView.Adapter<BestProductsViewHolder>(), Filterable {
...
class BestProductsViewHolder(private val binding: SampleAllProductLayoutBinding) :
